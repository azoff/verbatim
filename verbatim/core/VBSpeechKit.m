...
NSString *   SPEECHKIT_APP_ID = @"NMDPTRIAL_drnick2320140331164050";
NSString *   SPEECHKIT_HOST   = @"sandbox.nmdp.nuancemobility.net";
unsigned int SPEECHKIT_PORT   = 443;
BOOL         SPEECHKIT_SSL    = NO;
